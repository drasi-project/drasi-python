...
{{% alert title="No middle tier — just SQL" color="info" %}}
...
The whole demo is a single file, `tutorials/getting-started/app.py`. Here's what each part does; the [complete file](#all) is at the end.
