...
# Starts (and seeds) the database, then launches the Streamlit app in the
# foreground. The app embeds the Drasi engine, so this is the only process you
# need. Open the URL it prints (http://localhost:8501 by default) and drive the
# demo from the sidebar. Press Ctrl+C to stop, then run scripts/cleanup.ps1.
