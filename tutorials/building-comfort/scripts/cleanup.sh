...
# Cleanup Script
# Removes the PostgreSQL container. The app runs in the foreground, so stop it
# first with Ctrl+C. Pass --volumes to also delete the database volume.
