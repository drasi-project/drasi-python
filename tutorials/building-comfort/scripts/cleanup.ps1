...
# Stops the PostgreSQL container. The app runs in the foreground, so stop it
# first with Ctrl+C. Pass -RemoveVolumes to also delete the database volume.
...
Write-Host "=== Building Comfort - Cleanup ==="
Write-Host ""
